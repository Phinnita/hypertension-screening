...
# ส่วนที่ 1: ข้อมูลทั่วไปและสรีระวิทยา
...
with col_d:
    ...
    # ปัจจัยเสี่ยงระดับวิกฤตทางการแพทย์
...
# ส่วนที่ 3: พฤติกรรมการกินและสัญญาณชีพ
...
if submit:
    # ส่งค่าอินพุต 10 ฟีเจอร์เรียงตามลำดับโมเดลใหม่
    ...
    if prediction == 1 or sbp >= 140 or dbp >= 90:
        ...
        if sleep_apnea == 1:
            st.warning("• **ภาวะสงสัยการหยุดหายใจขณะหลับ (Obstructive Sleep Apnea):** การนอนกรนสะดุดทำให้ออกซิเจนในเลือดลดลงต่ำอย่างเฉียบพลันในตอนกลางคืน ซึ่งเป็นตัวการลับที่กระตุ้นให้ระบบประสาทซิมพาเธติกทำงานหนัก จนความดันโลหิตดีดตัวสูงขึ้นเรื้อรัง แนะนำให้ปรึกษาแพทย์เพื่อทำ Sleep Test")
        
        if exercise == 0:
            st.warning("• **พฤติกรรมเนือยนิ่ง / ขาดการออกกำลังกาย:** ส่งผลให้ความยืดหยุ่นของผนังหลอดเลือดลดลง หัวใจต้องทำงานหนักขึ้นในการสูบฉีดเลือด แนะนำให้ขยับร่างกายหรือเดินเร็วสะสมให้ได้ 150 นาทีต่อสัปดาห์")
    else:
        st.success("🟢 **ผลลัพธ์จาก AI: สัญญาณชีพและพฤติกรรมอยู่ในเกณฑ์เสี่ยงต่ำ (ปกติ)**")
        st.info("🎉 ข้อแนะนำ: ผลวิเคราะห์อยู่ในเกณฑ์ดีมาก! การรักษาระดับคุณภาพการนอนหลับและพฤติกรรมเคลื่อนไหวร่างกายที่เหมาะสมแบบนี้ จะช่วยรักษาความยืดหยุ่นของหลอดเลือดให้แข็งแรงในระยะยาวครับ")
